 ...
 */
public class MyExtractMethodRefactoring extends Refactoring {
	 ...
	 */
	public MyExtractMethodRefactoring(ICompilationUnit unit, int selectionStart, int selectionLength) {
		fCUnit= unit;
		fRoot= null;
	...
	public MyExtractMethodRefactoring(JavaRefactoringArguments arguments, RefactoringStatus status) {
	 ...
	 */
	public MyExtractMethodRefactoring(CompilationUnit astRoot, int selectionStart, int selectionLength) {
