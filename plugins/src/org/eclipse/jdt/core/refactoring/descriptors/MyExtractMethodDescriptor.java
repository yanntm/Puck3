 ...
 */
public final class MyExtractMethodDescriptor extends JavaRefactoringDescriptor {

	/**
	 * Creates a new refactoring descriptor.
	 */
	public MyExtractMethodDescriptor() {
	 ...
	 * @since 1.2
	 */
	public MyExtractMethodDescriptor(String project, String description, String comment, Map<String, String> arguments, int flags) {
		super(IJavaRefactorings.EXTRACT_METHOD, project, description, comment, arguments, flags);
	}
